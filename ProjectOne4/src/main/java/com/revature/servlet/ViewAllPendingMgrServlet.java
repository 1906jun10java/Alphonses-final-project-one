...
/**
 * Servlet implementation class ViewAllPendingMgrServlet
 */
public class ViewAllPendingMgrServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ViewAllPendingMgrServlet() {
        super();
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (session != null) {
			try {
				...
				tempList.addAll(userImpl.getAllPendingRequests());
